...
exports.getRecentlyPlayed = exports.removeHistory = exports.updateHistory = exports.getHistory = void 0;
...
const updateHistory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (sameAudioInHistory) {
        ...
        newHistory = yield history_1.default.findOneAndUpdate({
            owner: req.user.id,
            "all.audio": audio
        }, {
            $set: {
        ...
        newHistory = yield history_1.default.findByIdAndUpdate(oldHistory, {
...
const removeHistory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield history_1.default.findOneAndUpdate({ owner: req.user.id }, { $pull: { all: { _id: ids } } });
