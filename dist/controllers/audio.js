...
exports.getLatestUpload = exports.updateAudio = exports.createAudio = void 0;
...
const createAudio = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newAudio = new audio_1.default({
        ...
        about,
        category,
        owner: new mongodb_1.ObjectId(ownerId),
    ...
    yield newAudio.save();
    const pref = yield preferences_1.default.findOne({ owner: ownerId });
    if (pref) {
...
const getLatestUpload = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log(req);
