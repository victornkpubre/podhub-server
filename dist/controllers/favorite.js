...
exports.getIsFavorite = exports.getFavorite = exports.toggleFavorite = void 0;
...
const toggleFavorite = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (alreadyExists) {
        yield favorite_1.default.updateOne({ owner: req.user.id }, { $pull: { items: audioId } });
        status = "removed";
    }
    else {
        const favorite = yield favorite_1.default.findOne({ owner: req.user.id });
        if (favorite) {
            yield favorite_1.default.updateOne({ owner: req.user.id }, { $addToSet: { items: audioId } });
        }
        else {
