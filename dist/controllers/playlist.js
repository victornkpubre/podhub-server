...
const createPlaylist = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const duplicateTitle = yield playlist_1.default.findOne({ title: title });
    console.log(duplicateTitle);
    if (duplicateTitle)
        return res.status(422).json({ error: "You already have a playlist with this title" });
...
const removePlaylist = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (all === "yes") {
        const playlist = yield playlist_1.default.findByIdAndDelete({
            _id: playlistId,
            owner: req.user.id
        });
        if (!playlist)
